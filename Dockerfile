...
ADD https://raw.githubusercontent.com/dockerimages/ubuntu-installer/master/lampp.sh
ADD https://raw.githubusercontent.com/dockerimages/ubuntu-installer/master/webmin.sh
